...
def store_model_metrics_manual(y_true, y_pred, unique_labels, results_path):
    metrics = {}
    metrics["f1_weighted"] = f1_score(y_true, y_pred, labels=list(sorted(unique_labels)), average='weighted', zero_division=0)
